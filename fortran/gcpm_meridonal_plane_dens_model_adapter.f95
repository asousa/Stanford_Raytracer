...
module gcpm_meridonal_plane_dens_model_adapter
  use types
  use util
  ...
  type :: MPConstrainedStateData
     ...
     integer :: use_igrf
  end type MPConstrainedStateData
  ! Pointer container type.  This is the data that is actually marshalled.
  type :: MPConstrainedStateDataP 
     type(MPConstrainedStateData), pointer :: p
  end type MPConstrainedStateDataP
...
contains
  ...
  subroutine funcPlasmaParams(x, qs, Ns, ms, nus, B0, funcPlasmaParamsData)
    ...
    type(MPConstrainedStateDataP) :: datap
...
end module gcpm_meridonal_plane_dens_model_adapter
