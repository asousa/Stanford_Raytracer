!
!	transformation from GSM to MAG coordinates
!
...
!
	subroutine gsm_to_mag_d (itime,x_in,x_out)
			implicit none
!
	...
	integer*4 itime(2)
!
	call t3_d(itime,x_in,temp1,-1)
	call t2_d(itime,temp1,temp2,-1)
	call t1_d(itime,temp2,temp3,1)
	call t5_d(itime,temp3,x_out,1)
!
	return
	end
