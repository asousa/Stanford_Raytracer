...
d = 1e-8;
dfdk = dispersion_relation_dFdk(x(4:6), w0, x(1:3), d, funcPlasmaParams);
dfdw = dispersion_relation_dFdw(x(4:6), w0, x(1:3), d, funcPlasmaParams);
...
while( t < tmax )
  ...
  % Group velocity
  d = 1e-8;
  dfdk = dispersion_relation_dFdk(x(4:6), w, x(1:3), d, funcPlasmaParams);
  dfdw = dispersion_relation_dFdw(x(4:6), w, x(1:3), d, funcPlasmaParams);
