...
dfdk = dispersion_relation_dFdk(k, w, x, d, funcPlasmaParams);
dfdw = dispersion_relation_dFdw(k, w, x, d, funcPlasmaParams);
dfdx = dispersion_relation_dFdx(k, w, x, d, funcPlasmaParams);
